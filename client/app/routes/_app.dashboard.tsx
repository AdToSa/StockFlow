...
import { cn, formatCurrency, formatCompactNumber, formatDate } from '~/lib/utils';
...
export default function DashboardPage() {
  ...
  const { stats, charts, recentInvoices, lowStockAlerts, isLoading, refetch } = useDashboard();
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 h-80 bg-neutral-200 dark:bg-neutral-800 rounded-2xl animate-pulse" />
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card variant="default" padding="md" className="lg:col-span-2">
          <CardHeader className="pb-4">
            <CardTitle>Ventas de los ultimos 14 dias</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-72">
                  ...
                  {(recentInvoices?.length || 0) === 0 && (
                    <tr>
                      <td colSpan={5} className="px-6 py-12 text-center">
                        <FileText className="h-12 w-12 mx-auto text-neutral-300 dark:text-neutral-600 mb-3" />
                        <p className="text-sm text-neutral-500 dark:text-neutral-400">
