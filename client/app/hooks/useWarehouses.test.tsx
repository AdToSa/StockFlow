...
describe('useWarehouses hooks', () => {
  ...
  describe('useWarehousesWithFilters', () => {
    it('should fetch warehouses with no filters', async () => {
      vi.mocked(warehousesService.getWarehousesWithFilters).mockResolvedValue(mockWarehousesResponse);
    ...
    it('should fetch warehouses with search filter', async () => {
      ...
      expect(warehousesService.getWarehousesWithFilters).toHaveBeenCalledWith(filters);
    });
    ...
    it('should handle combined filters', async () => {
      ...
      const filters = { search: 'Bodega', city: 'Bogota', isActive: true, page: 1, limit: 10 };
      const { result } = renderHook(() => useWarehousesWithFilters(filters), {
        wrapper: createWrapper(),
      });
    ...
    it('should handle error state', async () => {
      ...
      vi.mocked(warehousesService.getWarehousesWithFilters).mockRejectedValue(error);
  ...
  describe('useWarehouses', () => {
    it('should fetch active warehouses', async () => {
      ...
      vi.mocked(warehousesService.getWarehouses).mockResolvedValue(activeWarehouses);
  ...
  describe('useAllWarehouses', () => {
    it('should fetch all warehouses including inactive', async () => {
      vi.mocked(warehousesService.getAllWarehouses).mockResolvedValue(mockWarehouses);
  ...
  describe('useWarehouse', () => {
    it('should fetch a single warehouse by id', async () => {
      vi.mocked(warehousesService.getWarehouse).mockResolvedValue(mockWarehouse);
  ...
  describe('useWarehouseStats', () => {
    it('should fetch warehouse stats by id', async () => {
      vi.mocked(warehousesService.getWarehouseStats).mockResolvedValue(mockWarehouseStats);
  ...
  describe('useCreateWarehouse', () => {
    it('should create a warehouse and navigate to warehouses list', async () => {
      ...
      vi.mocked(warehousesService.createWarehouse).mockResolvedValue(mockWarehouse);
    ...
    it('should show default error message if error has no message', async () => {
      const { toast } = await import('~/components/ui/Toast');
      vi.mocked(warehousesService.createWarehouse).mockRejectedValue(new Error(''));
  ...
  describe('useUpdateWarehouse', () => {
    it('should update a warehouse and navigate to warehouse detail', async () => {
      ...
      vi.mocked(warehousesService.updateWarehouse).mockResolvedValue(updatedWarehouse);
      ...
      expect(mockNavigate).toHaveBeenCalledWith(`/warehouses/${updatedWarehouse.id}`);
    });

    it('should update warehouse address', async () => {
      const { toast } = await import('~/components/ui/Toast');
      const updatedWarehouse = { ...mockWarehouse, address: 'Nueva Direccion #100' };
      vi.mocked(warehousesService.updateWarehouse).mockResolvedValue(updatedWarehouse);
    ...
    it('should show default error message if error has no message', async () => {
      const { toast } = await import('~/components/ui/Toast');
      vi.mocked(warehousesService.updateWarehouse).mockRejectedValue(new Error(''));
  ...
  describe('useDeleteWarehouse', () => {
    it('should delete a warehouse and navigate to warehouses list', async () => {
      ...
      expect(toast.success).toHaveBeenCalledWith('Bodega eliminada exitosamente');
      expect(mockNavigate).toHaveBeenCalledWith('/warehouses');
    });
    ...
    it('should show error when trying to delete warehouse with products', async () => {
      ...
      expect(toast.error).toHaveBeenCalledWith('No se puede eliminar una bodega con productos');
    });

    it('should show default error message if error has no message', async () => {
      const { toast } = await import('~/components/ui/Toast');
      vi.mocked(warehousesService.deleteWarehouse).mockRejectedValue(new Error(''));
